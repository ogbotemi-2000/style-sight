!function() {
    ...
    var S = function() {
        ...
        (n = [{
            ...
            value: function(e, t) {
                ...
                return this.target === n.ARRAY_BUFFER && (n.enableVertexAttribArray(i),
                n.vertexAttribPointer(i, this.size, this.type, this.normalized, 0, 0)),
                i
            }
        }, {
            key: "use",
            value: function(e) {
                ...
                this.target === t.ARRAY_BUFFER && (t.enableVertexAttribArray(e),
                t.vertexAttribPointer(e, this.size, this.type, this.normalized, 0, 0))
            }
        }]) && C(t.prototype, n),
        i && C(t, i),
        Object.defineProperty(t, "prototype", {
    ...
    var F = function() {
        ...
        n = [{
            ...
            value: function() {
                ...
                for (var n = 0; n <= this.ySegCount; n++)
                    for (var i = 0; i <= this.xSegCount; i++) {
                        ...
                        if (this.attributes.uv.values[2 * r] = i / this.xSegCount,
                        this.attributes.uv.values[2 * r + 1] = 1 - n / this.ySegCount,
                        this.attributes.uvNorm.values[2 * r] = i / this.xSegCount * 2 - 1,
                        this.attributes.uvNorm.values[2 * r + 1] = 1 - n / this.ySegCount * 2,
                        i < this.xSegCount && n < this.ySegCount) {
                            var a = n * this.xSegCount + i;
                            this.attributes.index.values[6 * a] = r,
                            this.attributes.index.values[6 * a + 1] = r + 1 + this.xSegCount,
                            this.attributes.index.values[6 * a + 2] = r + 1,
                            this.attributes.index.values[6 * a + 3] = r + 1,
                            this.attributes.index.values[6 * a + 4] = r + 1 + this.xSegCount,
                            this.attributes.index.values[6 * a + 5] = r + 2 + this.xSegCount
                        }
                    }
            ...
            value: function() {
                ...
                for (var i = e / -2, r = t / -2, a = e / this.xSegCount, o = t / this.ySegCount, s = 0; s <= this.ySegCount; s++)
                    for (var l = r + s * o, c = 0; c <= this.xSegCount; c++) {
                        var u = i + c * a
                          , h = s * (this.xSegCount + 1) + c;
                        this.attributes.position.values[3 * h + "xyz".indexOf(n[0])] = u,
                        this.attributes.position.values[3 * h + "xyz".indexOf(n[1])] = -l
                    }
    ...
    var E = function() {
        function e(t) {
            ...
            this._minigl = new l(this.getCanvas(),this.getCanvas().offsetWidth,this.getCanvas().offsetHeight),
            this.init()
        }
        var t, n, i;
        return t = e,
        n = [{
            ...
            value: function(e) {
                ...
                return void 0 === t && e in this._class.defaultOptions && (t = this._class.defaultOptions[e]),
            ...
            value: function() {
                ...
                this.getFlag("playing") && (this.setFlag("isScrolling", !0),
                this.pause())
            }
        }, {
            key: "handleScrollEnd",
            ...
            value: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0
                  , t = !!window.document.hidden || !this.getFlag("playing") || parseInt(e, 10) % 2 == 0
                  , n = this.getFlag("lastFrame", 0);
                if (t || (this.time += Math.min(e - n, 1e3 / 15),
                n = this.setFlag("lastFrame", e),
                this.mesh.material.uniforms.u_time.value = this.time,
                this._minigl.render()),
                0 !== n && this.getOption("static"))
                    return this._minigl.render(),
                    this.disconnect();
                this.getFlag("playing") && requestAnimationFrame(this.animate.bind(this))
            }
        }, {
            key: "pause",
            value: function() {
            ...
            key: "initMaterial",
            value: function() {
                var e = this.getOption("colors").map((function(e) {
                    if (4 === e.length) {
                        var t = e.substr(1).split("").map((function(e) {
                            return e + e
                        }
                        )).join("");
                        e = "#".concat(t)
                ...
                this.uniforms = {
                    ...
                    u_darken_top: new a(this._minigl,"float",this.getCanvas().dataset.jsDarkenTop ? 1 : 0),
                    u_active_colors: new a(this._minigl,"vec4",this.activeColors),
                    u_global: new a(this._minigl,"struct",{
                        noiseFreq: new a(this._minigl,"vec2",[this.freqX, this.freqY]),
                        noiseSpeed: new a(this._minigl,"float",5e-6)
                    }),
                    u_vertDeform: new a(this._minigl,"struct",{
                        incline: new a(this._minigl,"float",Math.sin(this.getOption("angle")) / Math.cos(this.getOption("angle"))),
                        offsetTop: new a(this._minigl,"float",-.5),
                        offsetBottom: new a(this._minigl,"float",-.5),
                        noiseFreq: new a(this._minigl,"vec2",[3, 4]),
                        noiseAmp: new a(this._minigl,"float",this.getOption("amplitude")),
                ...
                for (var t = 1; t < e.length; t += 1) {
                    var n = new a(this._minigl,"struct",{
                        ...
                        noiseFreq: new a(this._minigl,"vec2",[2 + t / e.length, 3 + t / e.length]),
                        noiseSpeed: new a(this._minigl,"float",11 + .3 * t),
                        noiseFlow: new a(this._minigl,"float",6.5 + .3 * t),
                        noiseSeed: new a(this._minigl,"float",this.seed + 10 * t),
                        noiseFloor: new a(this._minigl,"float",.1),
                        noiseCeil: new a(this._minigl,"float",.63 + .07 * t)
                    });
                    this.uniforms.u_waveLayers.value.push(n)
                }
                return this.vertexShader = [this.shaderFiles.noise, this.shaderFiles.blend, this.shaderFiles.vertex].join("\n\n"),
                new d(this._minigl,this.vertexShader,this.shaderFiles.fragment,this.uniforms)
            }
        }, {
            key: "initMesh",
            value: function() {
    ...
    window.Gradient = E,
    window.jQuery && (jQuery.fn.gradient = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        return e.canvas = this.get(0),
        this._gradient = new E(e),
        this
    }
    )
}();
